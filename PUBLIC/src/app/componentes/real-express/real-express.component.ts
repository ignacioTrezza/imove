...
import { selectToggleClientEventHandling, selectToggleRemoteClick } from '../../core/store/selectors/app.selectors';
...
export class RealExpressComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  initializeStoreEvents() {
    if (this.electronService.isElectron) {
      ...
      if (this.toggleClientEventHandlingg) {
      ...
      this.websocketService.handleClientEvent.subscribe((value) => {
        if (value) {
          if (this.toggleClientEventHandlingg === true) {
            this.handleClientEvent();
          } else {
            document.removeEventListener('keydown', this.handleKeyDown.bind(this));
            document.removeEventListener('mouseup', this.mouseUpListener);
