...
export class MoveComponent {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(AppSelectors.selectToggleRemoteClick)).subscribe((toggleRemoteClick: boolean) => {
      this.toggleRemoteClick = toggleRemoteClick;
          
    });
    this.store.pipe(select(AppSelectors.selectToggleEventHandling)).subscribe((toggleEventHandling: boolean) => {
      this.toggleEventHandling = toggleEventHandling;
    });
    
    this.store.pipe(select(AppSelectors.selectToggleGyroscope)).subscribe((toggleGyroscope: boolean) => {
      this.toggleGyroscope = toggleGyroscope;
    });
    this.store.pipe(select(AppSelectors.selectToggleAccelerometer)).subscribe((toggleAccelerometer: boolean) => {
      this.toggleAccelerometer = toggleAccelerometer;
    });
    this.store.pipe(select(AppSelectors.selectToggleAccelerometerIncludingGravity)).subscribe((toggleAccelerometerIncludingGravity: boolean) => {
      this.toggleAccelerometerIncludingGravity = toggleAccelerometerIncludingGravity;
    });
    this.store.pipe(select(AppSelectors.selectToggleClick)).subscribe((toggleClick: boolean) => {
      this.toggleClick = toggleClick;
    });
    this.store.pipe(select(AppSelectors.selectToggleMousePos)).subscribe((toggleMousePos: boolean) => {
      this.toggleMousePos = toggleMousePos;
    });
    this.store.pipe(select(AppSelectors.selectToggleClientEventHandling)).subscribe((toggleClientEventHandling: boolean) => {
